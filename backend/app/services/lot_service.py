...
class LotService:
    ...
    def create_lot(self, data: BirdLotCreate) -> BirdLot:
        ...
        return self.repository.create(lot)
    ...
    def update_lot(self, lot_id: int, data: BirdLotUpdate) -> BirdLot:
    ...
    def discard_lot(self, lot_id: int, data: BirdLotDiscard) -> BirdLot:
    ...
    def advance_week(self, lot_id: int) -> BirdLot:
    ...
    def evaluate_lot(self, lot_id: int) -> dict[str, bool | str]:
